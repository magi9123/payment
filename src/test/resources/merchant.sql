...
INSERT INTO transaction(uuid, amount, status, customer_email, customer_phone, created_at, reference_id)
VALUES (random_uuid(), 321312.00, 'APPROVED', 'someemail@gmail.com', '08776567567', current_timestamp,
